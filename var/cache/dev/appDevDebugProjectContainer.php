...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'facturier', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c2f203bdf834f800824a571c1aefa4330b5ca8e2cd3fb5fdb6e44bd08f06ed32');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('edward.cristian86@gmail.com');
        $a->setPassword('Suntpersuasiv1');
        $a->setAuthMode('login');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('570673c292be24.29209256')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'facturier',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'edward.cristian86@gmail.com',
            'mailer_password' => 'Suntpersuasiv1',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'edward.cristian86@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Suntpersuasiv1',
